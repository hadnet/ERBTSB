...
```bash
git clone  https://github.com/hadnet/ERBTSB.git your-project-name
```
...
[david-image]: https://img.shields.io/david/hadnet/ERBTSB.svg
[david-url]: https://david-dm.org//hadnet/ERBTSB
[david-dev-image]: https://img.shields.io/david/dev/hadnet/ERBTSB.svg?label=devDependencies
[david-dev-url]: https://david-dm.org/hadnet/ERBTSB?type=dev
